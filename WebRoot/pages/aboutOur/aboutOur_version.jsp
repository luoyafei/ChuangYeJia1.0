			...
			<div class="content-main" style="width: 100%;height: 100%;padding-bottom: 50px;background-color: white;overflow: hidden;border-bottom: solid #A9A9A9 2px;border-bottom-left-radius: 5px;border-bottom-right-radius: 5px;">
				<div class="content-main-top" style="height: 27%;">
					<div style="width: 80%;height: 100%;margin: 0 auto;">
						...
						 创业+网站，西安创加网络科技有限公司依法独立享有该软件之所有权利，本平台为商业网站，该网站使用者（含个人、法人或其他组织）：
						
						<ol>
							<li>非经西安创加网络科技有限公司授权许可，不得将之用于盈利或非盈利性的任何用途。</li>
							<li>为适应实际的计算机应用环境，对其功能、性能、界面，可以进行必要的修改；未经西安创加网络科技有限公司书面授书，不得向第三方提供修改后的软件。</li>
							<li>使用该软件必须保留西安创加网络科技有限公司的版权声明，将该软件从原有自然语言文字转换成另一自然语言文字的，仍应注明出处，并不得向任何第三方提供修改后的软件</li>
							<li>不得有其他侵犯西安创加网络科技有限公司软件版本权之行为。</li>
						</ol>
						
						    凡有上述侵权行为的个人、法人或其它组织，必须立即停止侵权并对其侵权造成的一切不良后果承担全部责任。对此前，尤其是此后侵犯西安创加网络科技有限公司版权的行为。西安创加网络科技有限公司将依据《著作权法》、《计算机软件保护条例》等相关法律、法规追究其经济责任和法律责任。
