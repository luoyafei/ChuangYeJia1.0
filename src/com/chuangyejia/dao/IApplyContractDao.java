...
public interface IApplyContractDao {
	 ...
	 * @return
	 */
	List<ApplyContract> getApplyContractInUserId(String userId, String status);
	/**
	 * 将某个公司被申请的申请，按照状态获取
	 * @param startupsId
	 * @param status
	 * @return
	 */
	List<ApplyContract> getApplyContractInStartupsId(String startupsId, String status);
	/**
